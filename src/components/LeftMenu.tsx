...
export default function LeftMenu(): JSX.Element {
    ...
    const dashboardLeftMenu: JSX.Element = <nav className="flex flex-col lg:w-64 w-0 text-lg overflow-hidden bg-orange-600">
        <h6 className="p-6 text-xl"><b>DASHBOARD</b></h6>
        <hr />
        <Link to={"/dashboard"} className={sidebarItem}><b>Dashboard</b></Link>
    </nav>

    const carsLeftMenu: JSX.Element = <nav className="flex flex-col lg:w-64 w-0 text-lg overflow-hidden bg-orange-600">
