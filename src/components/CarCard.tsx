...
export default function CarCard() {
    return <div className="bg-white p-7 max-w-sm">
        <img className="pt-5 px-2 mb-10" src="images/car.png" alt="Car" />
        ...
        <div className="flex gap-3 mt-5">
            <button className="flex gap-2 border-2 border-red-500 text-red-500 rounded-sm py-3 px-6 flex-1">
                <img src="images/icons/fi_trash.svg" alt="Del" /><b>Delete</b></button>
            <Link to='/editcar' className="flex items-center justify-center gap-2 bg-purple-700 text-white rounded-sm py-3 px-6 flex-1">
